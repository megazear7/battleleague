  ...
  $(function() {
    ...
    $(".move").on('click', function(event) {
      ...
      if ($(this).text() === "Cancel") {
        ...
        return $(".hidden").append($(".down-move"));
      } else {
        ...
        return $("#" + x + "-" + (parseInt(y) - 1)).append($(".down-move"));
      }
    });
    $(".left-move").on('click', function(event) {
      var id, x, y;
      id = $(this).parent().attr("id");
    ...
    $(".up-move").on('click', function(event) {
      var id, x, y;
      id = $(this).parent().attr("id");
      x = parseInt(id.substring(0, id.indexOf('-')));
      y = parseInt(id.substring(id.indexOf('-') + 1, id.length));
    ...
    $(".down-move").on('click', function(event) {
      var id, x, y;
      id = $(this).parent().attr("id");
      x = parseInt(id.substring(0, id.indexOf('-')));
      y = parseInt(id.substring(id.indexOf('-') + 1, id.length));
      ...
      $(this).find("#army_y_cord").val(y);
      $(this).find("form").attr("action", "/move/" + $("#current_army_id").val());
      return $(this).find("[method='post']").submit();
    });
