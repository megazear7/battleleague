...
(function() {
  $(function() {
    ...
    $(".move").on('click', function(event) {
      var army_id, id, rate, x, x_cord, y, y_cord, _i, _ref, _ref1, _results;
      if ($(this).text() === "Cancel") {
        $(this).text("Move").css("background-color", "blue");
        return $(".hidden").append($(".move-icon"));
      } else {
        ...
        _results = [];
        for (x_cord = _i = _ref = x - rate, _ref1 = x + rate; _ref <= _ref1 ? _i <= _ref1 : _i >= _ref1; x_cord = _ref <= _ref1 ? ++_i : --_i) {
          _results.push((function() {
            var _j, _ref2, _ref3, _results1;
            _results1 = [];
            for (y_cord = _j = _ref2 = y - rate, _ref3 = y + rate; _ref2 <= _ref3 ? _j <= _ref3 : _j >= _ref3; y_cord = _ref2 <= _ref3 ? ++_j : --_j) {
              if (x_cord !== x || y_cord !== y) {
                $("#" + x_cord + "-" + y_cord).append($(".move-icon").first().clone());
                _results1.push($(".move-icon").on('click', function(event) {
                  id = $(this).parent().attr("id");
                  x = parseInt(id.substring(0, id.indexOf('-')));
                  y = parseInt(id.substring(id.indexOf('-') + 1, id.length));
    ...
    $("#whisper").hide();
    $("#comment_comment_type").on('change', function(event) {
      if ($(this).val() === "whisper") {
        return $("#whisper").show();
      } else {
        return $("#whisper").hide();
    ...
    $(".space").on('click', function(event) {
      if ($(this).find("#is_clicked").val() === "0") {
        ...
        return $(this).find("#is_clicked").val(1);
      }
    });
    return $(".space").on('mouseleave', function(event) {
      if ($(this).find("#is_clicked").val() === "1") {
        $(this).css("left", parseFloat($(this).css("left")) + $(this).width() * 0.125);
        $(this).css("bottom", parseFloat($(this).css("bottom")) + $(this).height() * 0.125);
        $(this).width($(this).width() * (1 / 1.5));
        $(this).height($(this).height() * (1 / 1.5));
        return $(this).find("#is_clicked").val(0);
      }
    });
  });
...
(function() {
  $(function() {
    return $(".map-container").height($(".map-container").width());
  });
